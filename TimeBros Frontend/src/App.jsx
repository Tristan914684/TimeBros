        ...
        <div style={styles.outerCard}>
          ...
          <div className="split-left" style={styles.leftPanel}>
            ...
            <div style={styles.quote}>
              <span style={{ fontSize: 26, color: "#2563EB", lineHeight: 1, fontFamily: "Georgia, serif", display: "block", marginBottom: 4 }}>"</span>
              <p style={{ fontSize: 13, color: "#475569", lineHeight: 1.65, fontStyle: "italic" }}>
                A well-planned day leads<br />to a well-achieved future.
              </p>
              <div style={{ width: 28, height: 3, background: "#2563EB", borderRadius: 2, marginTop: 10 }} />
            </div>
          ...
          <div style={styles.rightPanel}>
            <div style={styles.loginCard}>
              ...
              <p className="fade-up delay-5" style={{ textAlign: "center", fontSize: 13.5, color: "#64748b", marginTop: 22 }}>
